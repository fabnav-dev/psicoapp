      ...
      {phase!=='listo' && (
        <div style={{ background:t.card, borderRadius:t.radius, border:`1px solid ${t.border}`, padding:18, marginBottom:12 }}>
          <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:12 }}>
            ...
            <div><div style={{ fontSize:13, fontWeight:700, color:t.ink }}>Informe Neurología.pdf</div><div style={{ fontSize:10.5, color:t.muted }}>Recibido del apoderado · Hoy 09:12</div></div>
          </div>
          ...
          <div key={e.id} style={{ background:t.card, border:`1px solid ${t.border}`, borderRadius:t.radius, overflow:'hidden' }}>
            ...
            {open===e.id && (
              <div style={{ padding:'4px 15px 15px', borderTop:`1px solid ${t.border}` }} className="fade">
                <div style={{ fontSize:10.5, fontWeight:800, color:t.primaryDark, textTransform:'uppercase', letterSpacing:0.5, margin:'12px 0 8px' }}>Apoyos en el aula</div>
                <div style={{ display:'flex', flexDirection:'column', gap:7 }}>
